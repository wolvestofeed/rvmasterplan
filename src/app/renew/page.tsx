    ...
    return (
        <div className="min-h-screen bg-[#f8fbf5] flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-2xl">
                ...
                <Card className="mt-8 border-2 shadow-xl border-[#2a4f3f] bg-white">
                    <CardHeader className="text-center pb-2">
                        <div className="mx-auto w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mb-4">
                            <AlertCircle className="h-6 w-6 text-amber-600" />
                        </div>
                        <CardTitle className="text-2xl font-bold text-[#2a4f3f]">Access Locked</CardTitle>
                    ...
                    <CardContent className="pt-6 space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {/* Option 1: Monthly */}
                            <div className="border border-slate-200 rounded-xl p-5 hover:border-[#8ca163] transition-colors relative flex flex-col">
                                <h3 className="font-semibold text-lg text-slate-800">Monthly Plan</h3>
                                <div className="mt-2 flex items-baseline text-3xl font-bold text-[#2a4f3f]">
                                ...
                                <ul className="mt-4 space-y-2 text-sm text-slate-600 flex-1">
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> Full System Access</li>
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> RV Setup Checklists</li>
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> Maintenance Logs</li>
                                </ul>
                                <Button className="w-full mt-6 bg-[#2a4f3f] hover:bg-[#1a3a2d]">
                                    Subscribe Monthly
                                </Button>
                            </div>

                            {/* Option 2: Annual */}
                            <div className="border-2 border-[#8ca163] bg-[#f8fbf5] rounded-xl p-5 relative flex flex-col shadow-sm">
                                ...
                                <p className="text-xs text-[#8ca163] font-medium mt-1">Save 17% overall</p>
                                <ul className="mt-4 space-y-2 text-sm text-slate-600 flex-1">
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> All Monthly Features</li>
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> Advanced Power Strategies</li>
                                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#8ca163] shrink-0" /> Priority Support</li>
                                </ul>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-100">
                            ...
                            <Link href="/">
                                <Button variant="outline" className="text-[#2a4f3f] border-[#2a4f3f] hover:bg-[#f8fbf5]">
