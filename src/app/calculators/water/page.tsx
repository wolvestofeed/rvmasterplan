        ...
        <div className="container mx-auto py-10 px-4 md:px-8 max-w-6xl">
            ...
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-heading font-bold text-gray-900 flex items-center">
                    <DropletIcon className="mr-3 h-8 w-8 text-blue-500" />
                    Water Calculator
                </h1>
            ...
            {/* Hero Banner */}
            <div className="rounded-2xl overflow-hidden mb-8 relative bg-blue-900 min-h-[200px]">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-900 to-blue-900 p-8 flex items-end">
                    <div className="text-white max-w-lg">
                        <h2 className="text-2xl font-bold mb-2 flex items-center">
                            Water Management is Survival
                        </h2>
                        <p className="mb-4 text-blue-100">
                            Calculate daily water usage, estimate days to empty, and establish habits for staying off-grid longer.
                        </p>
                    </div>
                </div>
            </div>
