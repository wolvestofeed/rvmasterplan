        ...
        <div className="container mx-auto py-10 px-4 md:px-8 max-w-6xl">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <h1 className="text-3xl font-heading font-bold text-gray-900 flex items-center">
                    <DollarSign className="mr-3 h-8 w-8 text-purple-600" />
                    RV Living Budget
                </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <Card className="border-t-2 border-t-purple-600 shadow-sm">
                ...
                <Card className="border-t-2 border-t-blue-600 shadow-sm">
